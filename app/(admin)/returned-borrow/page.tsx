...
import { getAllBorrowed, getAllBorrowedApproved, getAllBorrowedReturned } from '@/services/borrow'
import { Button } from '@/components/ui/button'
import ApproveActions from '../approve-borrow/_components/ApproveActions'

const ReturnedBorrow = async () => {
  const data = await getAllBorrowedReturned()
